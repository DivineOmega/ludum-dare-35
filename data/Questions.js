var questions = [
  {
    'question': 'What animal transformation would allow you to \'meow\'?',
    'answers': ['cat', 'kitten', 'feline', 'kitty']
  },
  {
    'question': 'If you needed to unlock a door, what could you shapeshift into?',
    'answers': ['key', 'pick']
  },
  {
  ...
  {
    'question': 'If you needed to imitate someone patrolling a secure area, changing to what type of person would be appropriate?',
    'answers': ['guard', 'police', 'security', 'patrol', 'cop', 'fuzz']
  },
  {
    'question': 'In a stealth situation, you need to hear a conversation going on in a different room. What small animal transformation would be best?',
